...
{ 
 if(new_ang !=0 )
 {
  ...
  //Serial.print("total angle covered in degrees");Serial.print(total_ang);
  //Serial.println("");
  distance_moved = total_ang *2*PI*wheel_radius/360; //calculate distance moved in metre
  //Serial.print("total distance travelled");Serial.print(distance_moved);
  //Serial.println("");
  ang_vel = change_in_ang*1000 * 60  / (BNO055_SAMPLERATE_DELAY_MS * 360 );
  old_ang = new_ang ;
  Serial.print("ang_speed in rpm");Serial.print(ang_vel);
  }
}
/**************************************************************************/
/*
